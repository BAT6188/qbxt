...
public class QueryBeanTest {
	...
	public void testGetSolrQuery(){
		...
		QueryBean bean1=new QueryBean(null, null, null, null, null, 
				null, null, null, "2011-01-01", "2011-01-01");
		System.err.println(bean1.initQuery(PersonStore.class));
		
		QueryBean bean2=new QueryBean(null, null, null, "infoType", "董昊", 
				null, null, null, "2011-01-01", "2012-01-01");
		System.err.println(bean2.initQuery(PersonStore.class));
		System.err.println(bean2.getSolrQuery(PersonStore.class));
		
		QueryBean bean3=new QueryBean(null, null, null, "infoType", "董昊", 
				"personName", null, "infoType", "2011-01-01", "2012-01-01");
