 ...
 * @author 王百林
 */
Ext.define('Ushine.cluesInfo.SelectAssociatedWebsiteJournalDataGridPanel', {
	extend: 'Ext.grid.Panel',
	//enableColumnResize:是否允许改变列宽，默认为true
	id:"SelectAssociatedWebsiteJournalDataGridPanelId",
	itemId:'SelectAssociatedWebsiteJournalDataId',
	border:true,
	height:340,
	...
	constructor: function(type) {
		...
		this.store=Ext.create('Ext.data.JsonStore',{
			...
			fields:[{name : 'id',type : 'string',flex: 1,mapping : 'id'},
			        ...
			        {name : 'mainWholesaleAddress',type : 'string',flex: 1,mapping : 'mainWholesaleAddress'},
			        {name : 'establishPerson',type : 'string',flex: 1,mapping : 'establishPerson'},
