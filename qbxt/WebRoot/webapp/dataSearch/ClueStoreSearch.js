 ...
 * 一键搜索命中线索
 */
Ext.define('Ushine.dataSearch.ClueStoreSearch',{
	extend:'Ext.panel.Panel',
	id:'dataserach_cluestoreserach',
	...
	constructor: function(config) {
		...
		this.items = [         
		   ...
		   Ext.create('Ushine.base.TitleBar', {
		       cTitle: "符合条件为<font color='orange'>"+config.fieldValue+"</font>的线索",
		       btnItems: [
						// 返回任务操作
				...
				items:[{
							...
							listeners:{
								 specialkey:function(field,e){
		                           if(e.getKey() == e.ENTER){
		                           		//按下enter键
		   			        			self.remove('c_cluestoresearch_gridpanel');
		   			        			self.add(Ext.create('Ushine.dataSearch.ClueStoreSearchGridPanel',{
		...
		//线索gridpanel
			new Ushine.dataSearch.ClueStoreSearchGridPanel({
				fieldValue:config.fieldValue,
				nowFieldValue:''
			})
		];	
