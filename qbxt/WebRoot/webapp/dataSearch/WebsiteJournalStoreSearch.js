 ...
 * 一键搜索媒体网站刊物
 */
Ext.define('Ushine.dataSearch.WebsiteJournalStoreSearch',{
	extend:'Ext.panel.Panel',
	id:'dataserach_websitejournalstoresearch',
	...
	constructor: function(config) {
		...
		this.items = [         
		   ...
		   Ext.create('Ushine.base.TitleBar', {
		       cTitle: "符合条件为<font color='orange'>"+config.fieldValue+"</font>的媒体网站刊物",
		       btnItems: [
				...
				items:[{
							...
							listeners:{
								 specialkey:function(field,e){
		                           if(e.getKey() == e.ENTER){
		                           		//按下enter键
		                        	   self.remove('p_websitejournalstoreserach_gridpanel');
		                        	   self.add(Ext.create('Ushine.dataSearch.WebsiteJournalStoreSearchGridPanel',{
			...
			//媒体网站的gridpanel
			new Ushine.dataSearch.WebsiteJournalStoreSearchGridPanel({
				fieldValue:config.fieldValue,
				nowFieldValue:''
			})
		];	
