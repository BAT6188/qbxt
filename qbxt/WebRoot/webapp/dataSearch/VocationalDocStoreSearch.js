 ...
 * 一键搜索命中业务文档
 */
Ext.define('Ushine.dataSearch.VocationalDocStoreSearch',{
	extend:'Ext.panel.Panel',
	id:'dataserach_vocationaldocstoresearch',
	...
	constructor: function(config) {
		...
		this.items = [         
		   ...
		   Ext.create('Ushine.base.TitleBar', {
		       cTitle: "符合条件为<font color='orange'>"+config.fieldValue+"</font>的业务文档",
		       btnItems: [
						// 返回任务操作
				...
				items:[{
							...
							listeners:{
								 specialkey:function(field,e){
		                           if(e.getKey() == e.ENTER){
		                           		//按下enter键
			   			        		self.remove('d_vocationaldocstoresearch_gridpanel');
			   			        		self.add(Ext.create('Ushine.dataSearch.VocationalDocStoreSearchGridPanel',{
		...
		//业务文档gridpanel
		new Ushine.dataSearch.VocationalDocStoreSearchGridPanel({
			fieldValue:config.fieldValue,
			nowFieldValue:''
		})
		];	
