 ...
 * 一键搜索命中外来文档
 */
Ext.define('Ushine.dataSearch.OutsideDocStoreSearch',{
	extend:'Ext.panel.Panel',
	id:'dataserach_outsidedocstoresearch',
	...
	constructor: function(config) {
		...
		this.items = [         
		   ...
		   Ext.create('Ushine.base.TitleBar', {
		       cTitle: "符合条件为<font color='orange'>"+config.fieldValue+"</font>的外来文档",
		       btnItems: [
						// 返回任务操作
				...
				items:[{
							...
							listeners:{
								 specialkey:function(field,e){
		                           if(e.getKey() == e.ENTER){
		                           		//按下enter键
			   			        		self.remove('p_outsidedocstoresearch_gridpanel');
			   			        		self.add(Ext.create('Ushine.dataSearch.OutsideDocStoreSearchGridPanel',{
		...
		//人员gridpanel
			new Ushine.dataSearch.OutsideDocStoreSearchGridPanel({
				fieldValue:config.fieldValue,
				nowFieldValue:''
			})
		];	
